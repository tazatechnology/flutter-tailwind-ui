...
import 'package:flutter_tailwind_ui/src/markdown/_functions_io.dart'
    if (dart.library.js_interop) '_functions_web.dart';
import 'package:flutter_tailwind_ui/src/markdown/style_sheet.dart';
import 'package:flutter_tailwind_ui/src/markdown/widget.dart';
import 'package:markdown/markdown.dart' as md;

/// https://github.com/flutter/flutter/issues/139130#issuecomment-2593790860
const kEnd = '===END===';
...
class MarkdownBuilder implements md.NodeVisitor {
  ...
  void visitText(md.Text text) {
    ...
    String trimText(String value) {
      ...
      final RegExp leadingSpacesPattern = RegExp('^ *');
    ...
    if (_blocks.isNotEmpty && builders.containsKey(_blocks.last.tag)) {
      ...
      child = _buildRichText(
        TextSpan(
          ...
          // Links are handled in their own <a> tag builder
