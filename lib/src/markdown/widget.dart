...
import 'package:flutter_tailwind_ui/src/markdown/builder.dart';
...
class _MarkdownWidgetState extends State<MarkdownWidget>
  ...
  @override
  TextSpan formatText(MarkdownStyleSheet styleSheet, String value) {
    final code = value.replaceAll(RegExp(r'\n$'), '');
